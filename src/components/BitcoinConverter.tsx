  ...
  return (
    <Card className="w-full max-w-lg mx-auto overflow-hidden animate-fade-in shadow-lg border-t-2 border-t-bitcoin border-b-2 border-b-ethereum">
      <CardHeader className="bg-gradient-to-r from-bitcoin/10 to-ethereum/10 text-center pb-6">
        <CardTitle className="text-2xl">Bitcoin to EVM Converter</CardTitle>
        <CardDescription className="text-sm">
          Convert Bitcoin addresses to checksummed EVM addresses
        </CardDescription>
      </CardHeader>
        ...
        {evmAddress && (
          <div className="mt-4 p-3 bg-muted rounded-md animate-pulse-slow">
            <p className="text-xs text-center">
              This EVM address was generated by applying keccak256 to the Bitcoin address
              P2PKH script and taking the last 20 bytes, then checksummed per EIP-55.
            </p>
          </div>
        )}
      </CardContent>
